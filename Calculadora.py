...
def calculate():
    ...
    # Easter egg 1: Se o usuário digitou "2+2"
    if texto == "2+2":
        value_text.set("Peixe")
        all_values = ""
        return

    # Easter egg 2: Se o usuário digitou "6"
    if texto == "6":
        value_text.set("Abrindo link...")
        all_values = ""
        webbrowser.open("https://youtu.be/VQRLujxTm3c?si=0e5pgnGMVHJDRxC4")
        return

    modulos = ['math.tan', 'math.sin', 'math.cos', 'math.sqrt', 'math.log', 'math.log10', 'math.e', 'math.pow', 'math.pi', 'math.radians']
